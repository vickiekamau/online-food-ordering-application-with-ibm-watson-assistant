...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        minflater.inflate(R.menu.super_menu,menu);
    ...
    private void sendMessage() {
        ...
        else
        {
            ...
            Toast.makeText(getApplicationContext(),"Tap on the message to send your message to the virtual assistant",Toast.LENGTH_LONG).show();
        ...
        assistantservice.setUsernameAndPassword("apikey", "JxgJkpLJLGnftUMcZ5-YLaGRtu0MiL7ZgS1TfklCQjwD");

        //TODO: Uncomment this line if you want to use API KEY
        assistantservice.setApiKey("JxgJkpLJLGnftUMcZ5-YLaGRtu0MiL7ZgS1TfklCQjwD");
        ...
        MessageOptions options = new MessageOptions.Builder().workspaceId("54352a5a-535b-4b89-bf0d-2c9d3911d5cd").input(input).context(context).build();
